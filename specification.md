...
| contains      | array \<PluginFormat | ProjectFormat                                                                                                                                                                  | PresetFormat\>                                                                                                       | Plugin/Project/Preset formats (see tables for list of possible values) | `["vst3"]` |
...
| size          | number               | File size                                                                                                                                                                      | `94448096`                                                                                                           |
